...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-57f88920.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-a7434114.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'products':{url:'http://localhost:5001/assets/remoteEntry.js',format:'esm',from:'vite'},
  'cart':{url:'http://localhost:5002/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-57f88920.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-dom-a7434114.js', import.meta.url).href, remoteFrom), loaded:1}}
...
const ProductsList = React$1.lazy(() => __federation_method_getRemote("products" , "./ProductsList").then(module=>__federation_method_wrapDefault(module, true)));
const ShoppingCart = React$1.lazy(() => __federation_method_getRemote("cart" , "./ShoppingCart").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Micro Frontend Demo" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "20px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading Products..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductsList, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading Cart..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, {}) }) })
    ] })
  ] });
}
class ErrorBoundary extends React$1.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Error loading component" });
    }
