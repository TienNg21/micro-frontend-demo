...
const currentImports = {};
      ...
      let moduleMap = {
"./ProductsList":()=>{
      dynamicLoadingCss([], false, './ProductsList');
      return __federation_import('./__federation_expose_ProductsList-2a8139b2.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__products__' + exposeItemName;
