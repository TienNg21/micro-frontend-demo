...
const currentImports = {};
      ...
      let moduleMap = {
"./ShoppingCart":()=>{
      dynamicLoadingCss([], false, './ShoppingCart');
      return __federation_import('./__federation_expose_ShoppingCart-d5682dfd.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__cart__' + exposeItemName;
